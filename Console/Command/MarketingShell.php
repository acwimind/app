...
class MarketingShell extends AppShell {
    ...
    public function TestShell(){
       ...
       if (count($this->args) > 0){
                ...
                for ($i=0;$i<=count($this->args)-1;$i++){ 
                        print('valore passato : '.$this->args[$i].' ---- ');
                        }
       }
        else 
            print('Errore : Omessi parametri');                                                          
   }
   ...
   public function chatBonusMsg($partnerMember,$textMsg) {
      ...
      public function scheduleBonus(){
       //schedula Bonus
       
       /*
       * $params=count($this->args); //parametri da passare da linea di comando
       * $this->args[0] contiene il primo param
       * $this->args[1] contiene il secondo param
       * 
       */
       $db = $this->Member->getDataSource();
       $op=2;   //id Bonus da accreditare vedere tabella tmp_bonus
       $elem=30;  //messaggi + push da inviare ad ogni esecuzione
       $message = "Buon 2015 da Haamble! Vuoi iniziare questo Anno con nuovi interessanti incontri ? ".
                  "Ti abbiamo regalato 50 crediti di bonus, che puoi sfruttare subito per essere più visibile sul radar della tua città."; //testo del messaggio
       $msg = utf8_encode($message);//Fondamentale altrimenti non invia i caratteri accentati.
       ...
       try {
        ...
        catch (Exception $e)
        {
         ...
         /* Parte usate per i test dopo aver commentato la query sopra
         
         $fakeUsersXXX=array('45920400','45920407','45920410','45920414','45920420','45920424','45920427','45920433','45920439','45920442','45920447',
                          '45920452','45920457','45920462','45920468','45920472','45920476','45920479','45920482','45920485','45920488','45920491',
                          '45920494','45920497','45920500','45933295','45933298','45933301','45933304','45933307','45933310','45933313','45933316',
                          '45933319','45933322','45933325','45933328','45933331','45933334','45933337','45933340','45933343','45933346','45933349',
                          '45933352','45933355','45933358','45933361','45933364','45933367','45933370','45933373','45933376','45933379',
                          '45545831','45517058','45710937','44548401');
                          
         $MyfakeUsers=array('45545831','45517058','45710937');                  
         ...
         */
         ...
         /*
             TODO
             //Alla fine degli invii verifica se ci sono stati nuovi iscritti durante gli invii e li aggiunge
             //alla lista dei destinatari del Bonus
             
             INSERT INTO tmp_bonus(member_id,reason,amount,operation)
             SELECT big,'Bonus Capodanno 30 dicembre','50','1' 
             FROM members
             LEFT JOIN tmp_bonus ON big=member_id
             WHERE reason IS NULL AND members.status<255
