...
<?php
echo '<h2>' . ( isset($this->data['Event']) && $this->data['Event']['big']>0 ? __('Edit Event %s', $this->data['Event']['name']) : __('New Event') ) . '</h2>';
...
echo $this->AdvForm->inputs(array(
	...
	'Place.big' => array('label' => __('Associated Place'), 'options' => $places),
