<?php echo $this->Form->create('', array('type' => 'get', 'id' => 'map-filter')); ?>
<div class="location">
    <h3>Country</h3>
    <?php
...
$('form#map-filter').on('click', 'ul#city-autocomplete li', function(){
...
$('form#map-filter').submit(function(){

    if (typeof map != 'undefined' && map != null) {
        
        set_map_filter(
            $('input#PlaceCity', $(this)).val(),
            $('select#PlaceCountry option:selected', $(this)).html()
        );
