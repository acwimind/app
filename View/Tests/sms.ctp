...
// Invio SMS CLASSIC con mittente personalizzato di tipo alfanumerico
 $result = skebbyGatewaySendSMS('haamble','haamble2014',$recipients,'Hi Mike, how are you?', SMS_TYPE_CLASSIC,'','Haamble');
...
$p_c = array("+393317200494");
$j_c = json_encode($p_c);

$url='http://www.freesmsgateway.com/api_send';
$fields = array(
'access_token'=>'f496118f4a9987e9b6f11daa461eb959',
'message'=>'HmblRegCd  3124562',
'send_to'=>'post_contacts',post_contacts=>urlencode($j_c),
);
