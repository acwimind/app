 ...
 */
	...
	Router::connect('/admin/dashboard', array('controller' => 'pages', 'action' => 'display', 'home', 'admin' => true));
	Router::connect('/operator/dashboard', array('controller' => 'places', 'action' => 'index', 'operator' => true));
/**
