...
//		);
	...
	public function getBoardPlaces($MemberID, $offset=0) {
        ...
        $PrivacySetting = ClassRegistry::init('PrivacySetting');
        $privacySettings=$PrivacySetting->getPrivacySettings($MemberID);
        
        if ($privacySettings[0]['PrivacySetting']['showvisitedplaces']>0)
