...
//			'fields' => 'ChatMessage.created',
    ...
    public function findConversationsDARIVEDERE($memberBig, $offset = 0, $fromChat = false)
    {
...
//                debug($e);
    ...
    public function findConversationsNew($memberBig, $offset = 0, $fromChat = false)
	{
		...
		$db = $this->getDataSource();
		$query = "WITH convers AS (SELECT \"Sender\".\"big\" AS \"Sender__big\", \"Sender\".\"name\" AS \"Sender__name\",".
                 "\"Sender\".\"middle_name\" AS \"Sender__middle_name\",\"Sender\".\"surname\" AS \"Sender__surname\",".
                 "\"Sender\".\"photo_updated\" AS \"Sender__photo_updated\",\"Recipient\".\"big\" AS \"Recipient__big\",".
                 "\"Recipient\".\"name\" AS \"Recipient__name\", \"Recipient\".\"middle_name\" AS \"Recipient__middle_name\",".
                 "\"Recipient\".\"surname\" AS \"Recipient__surname\",".
		...
		//  \"Sender\".\"status\"<255 AND
		
		
          $query.="SELECT convers.*,Sender.photosvisibility AS \"Sender__photosvisibility\",".
                  "Recipient.photosvisibility AS \"Recipient__photosvisibility\",friends.status AS \"MemberRel__status\" ".
                  "FROM convers ".
                  "LEFT JOIN (SELECT * FROM privacy_settings ) AS Sender ON \"Sender__big\"=Sender.member_big ".
                  "LEFT JOIN (SELECT * FROM privacy_settings ) AS Recipient ON \"Recipient__big\"=Recipient.member_big ".
                  "LEFT JOIN friends ON ((\"Sender__big\"=member1_big OR \"Recipient__big\"=member1_big) ".
                  "AND (\"Sender__big\"=member2_big OR \"Recipient__big\"=member2_big))";
