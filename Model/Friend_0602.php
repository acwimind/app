...
class Friend extends AppModel {
	...
	public function getDiaryFriends($MemberID,$offset=0) {
        ...
        if (count( $FriendsID ) > 0) {
			...
			$MySql = ' SELECT   members.big,  members.fb_id,  members.name,  members.middle_name,  members.surname,  members.photo_updated,  members.birth_date,  members.sex,  members.last_lonlat '.
		             'FROM public.members '.
  ...
  // checkins.created DESC 
	...
	public function FriendsRelationship($memberOne, $memberTwo, $relation) {
		...
		$MySql = "SELECT * FROM friends ".
                 "WHERE (member1_big=$memberOne OR member2_big=$memberOne) ".
                 "AND (member1_big=$memberTwo OR member2_big=$memberTwo) AND status='$relation' ".
                 "ORDER BY created DESC";
		// try {
		$result = $db->fetchAll ( $MySql );
    ...
    public function findAllFriendsWithBad($memberBig) {
        ...
        $query="SELECT member1_big AS myfriend ".
               "FROM friends ".
               "WHERE member2_big=$memberBig ".
               "UNION ".
               "SELECT member2_big AS myfriend ".
               "FROM friends ".
               "WHERE member1_big=$memberBig";
    ...
    public function badFriends($membig){
        ...
        $query="SELECT from_big AS ignore ".
               "FROM member_settings ".
               "WHERE to_big=$membig AND chat_ignore=1 ".
               "UNION ".
               "SELECT to_big AS ignore ".
               "FROM member_settings ".
    ...
    public function findFriendsNew($memberBig,$offset=0) {
        ...
        */
        $query="WITH amici AS (SELECT member1_big AS friend ".
                              "FROM friends ".
                              "WHERE member2_big=$memberBig AND status='A' ".
                              "UNION ".
                              "SELECT member2_big AS friend ".
                              "FROM friends ".
                              "WHERE member1_big=$memberBig AND status='A' ".
                              "ORDER BY friend ASC ) ".
               
               "SELECT m.big,m.name,m.middle_name,m.surname,m.photo_updated,m.birth_date,m.sex,ps.visibletousers,ps.fbintegration,".
               "ps.disconnectplace,ps.profilestatus,ps.showvisitedplaces,ps.sharecontacts,ps.notifyprofileviews,ps.notifyfriendshiprequests,".
               "ps.notifychatmessages,ps.boardsponsor,ps.checkinsvisibility,ps.photosvisibility,ps.friendsvisibility ".
               "FROM amici ".
               "JOIN members m ON friend=m.big ".
               "LEFT JOIN privacy_settings ps ON ps.member_big=m.big ".
               "WHERE m.status<255 AND m.big NOT IN (SELECT from_big as badfriend ".
                                                    "FROM member_settings ".
                                                    "WHERE to_big=$memberBig ".
                                                    "UNION ".
                                                    "SELECT to_big as badfriend ".
                                                    "FROM member_settings ".
                                                    "WHERE from_big=$memberBig)".
